...
#----------------------Jupyterhub-------------------------------
  ...
  <Location /home>
    ...
    Require valid-user
    ShibUseHeaders On
    ProxyPass        http://databrix:3000/home
    ProxyPassReverse http://databrix:3000/home
  </Location>
  ...
  RewriteRule /home/(.*) ws://databrix:3000/home/$1 [P,L]
  RewriteRule /home/(.*) http://databrix:3000/home/$1 [P,L]
