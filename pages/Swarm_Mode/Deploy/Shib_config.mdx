...
```
## attribute-map.xml
**attribute-map.xml** definiert welche Attribution werden von shibboleth angezeigt und in http Headers hinzugefügt. 
Folgende Attribution zeigt ob der User ein Mitarbeiter oder ein Student ist. Diese müssen Sie in **attribute-map.xml** schreiben.
